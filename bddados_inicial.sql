...
ALTER DEFAULT PRIVILEGES IN SCHEMA public -- Para objetos criados pelo usuário atual (ex: postgres)
   GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO xerife_user;
...
-- Tabela users
    ...
    DO $$
    BEGIN
    RAISE NOTICE 'Script de setup do banco de dados "Xerife" (com Ordens de Serviço e Funcionários) concluído com sucesso!';
    END
    $$;